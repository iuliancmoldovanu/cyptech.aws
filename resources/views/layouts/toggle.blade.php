    ...
    <aside class="main-sidebar">
        ...
        <!-- sidebar menu: : style can be found in sidebar.less -->
            <ul class="sidebar-menu">
                ...
                @endif
                @if($player->user->role == 'super_admin')
                    <li class="header">Masters</li>
                    <li class="treeview {{ (Request::is('super_admin')) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-user-secret" aria-hidden="true"></i><span>Super</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                    ...
                    {{--<li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Masters</span></a></li>--}}
        ...
        <section class="content-header">
            <h1>
                <small><b>{{ucwords($player->user->role)}}</b>
                    Role (Last login:
                    @if(Session::has('last_access_at'))
                        {{ date_format(date_create(Session::get('last_access_at')),"D dS") }} of
                        {{ date_format(date_create(Session::get('last_access_at')),"M y") }} at
                        {{ date_format(date_create(Session::get('last_access_at')),"H:i") }})
                    @endif
                </small>
            </h1>
